...
$db=new clasedb();
$conex=$db->conectar();
$sql="SELECT * FROM datos_personales WHERE cedula=".$id." AND id<>".$id_persona;
echo $sql;
...
if($cant>0)
{
	...
	<script type="text/javascript">
		...
		window.location="PersonasControlador"
...
$sql="UPDATE datos_personales SET nombres='".$nombres."',apellidos='".$apellidos."',cedula=".$id." WHERE id=".$id_persona;
$res=mysqli_query($conex,$sql);
if($res)
		{
